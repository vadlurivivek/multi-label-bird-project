...
print("Loading saved Weights for layer 1 and 2 ...")
file_ID = "./data/parameters_mfcc_2.pkl"
f = open(file_ID, "rb")
W = pickle.load(f)
b = pickle.load(f)
f.close()
...
with tf.Session() as sess:
	...
	print("Optimization Finished!")	# summary_writer.flush()
	...
	file_ID = path + "parameters_mfcc_3.pkl"
	f = open(file_ID, "wb")
